 ...
 *
 * Note: all the database operations are wrapped in a transaction and rolled back at the end of each test.
 ...
 *
 * Use the following query to view results inside the transaction:
