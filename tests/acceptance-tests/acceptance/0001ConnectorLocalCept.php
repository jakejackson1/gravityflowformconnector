...
$I->wantTo( 'Test the Form Connector with a local form for new, update and delete entry steps' );

// Submit the form
$I->amOnPage( '/0001-formconnector-source' );

$I->see( '0001 FormConnector - Source' );
...
$I->click( 'Verify After Local New Entry' );
...
// Re-Verify Connected Form Values (Local)
$I->click( 'Verify After Local Update Entry' );
$I->waitForText( 'Status: Pending', 3 );
...
//Update Source Values
$I->amOnWorkflowPage( 'Inbox' );
$I->click( 'Source - Let Local Be Verified' );
$I->see( '0001 FormConnector - Source' );
...
$I->amOnWorkflowPage( 'Inbox' );
$I->dontSee( 'Verify After Local Update Entry' );
